#!/usr/bin/env python3
"""Compare PexCraft worldgen_125_dump output against Java 1.2.5 golden hashes.
...
Example:
  ...
  python3 tools/worldgen_125_compare_hashes.py golden.csv current_dump.txt
"""
import csv
import re
import sys
...
def main():
    if len(sys.argv) != 3:
        print("usage: worldgen_125_compare_hashes.py <golden.csv> <current_dump.txt>", file=sys.stderr)
        return 2
