/* PEXCRAFT regular Android unity entry.
   Platform code lives under src/platform/android/.  It reuses SDL2, the
   OpenGL ES 2.0 fixed-function compatibility renderer, PE-style touchscreen
...
#include "platform/android/android_gles2_renderer.c"
...
#define glCopyTexSubImage2D android_gl_copy_tex_sub_image_2d
...
#include "platform/android/android_filesystem.c"
...
static float g_android_touch_ray_dz = 1.0f;
...
#include "ui/gui.c"
#include "platform/android/android_touch.c"
#include "platform/gamepad.c"
#include "render/render_dispatch.c"
#include "platform/android/android_app.c"
