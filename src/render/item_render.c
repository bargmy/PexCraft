...
static const char *item_display_translation_key(int id) {
    ...
    if (id == ITEM_DIAMOND) return "item.emerald.name";
    ...
    if (id == ITEM_SIGN) return "tile.sign.name";
    if (id == ITEM_DOOR_WOOD) return "tile.doorWood.name";
    ...
    if (id == ITEM_DOOR_IRON) return "tile.doorIron.name";
    ...
    if (id == ITEM_BRICK) return "tile.brick.name";
    if (id == ITEM_CLAY) return "tile.clay.name";
    if (id == ITEM_REED) return "tile.reeds.name";
    ...
    if (id == ITEM_CAKE) return "tile.cake.name";
    if (id == ITEM_BED) return "tile.bed.name";
    if (id == ITEM_REDSTONE_REPEATER) return "tile.diode.name";
    if (id == ITEM_COOKIE) return "item.cookie.name";
    if (id == ITEM_MAP) return "item.map.name";
    if (id == ITEM_SHEARS) return "item.shears.name";
    if (id == ITEM_MELON) return "tile.melon.name";
    ...
    if (id == ITEM_NETHER_WART) return "tile.netherStalk.name";
    ...
    if (id == ITEM_BREWING_STAND) return "tile.brewingStand.name";
    if (id == ITEM_CAULDRON) return "tile.cauldron.name";
