/* Android native platform filesystem/timing layer.
...
static const char *android_data_base(void) {
...
static void init_dirs(void) {
    const char *base = android_data_base();
    ...
    PEX_ANDROID_LOGI("PEXCRAFT Android data dir: %s", g_mc_dir);
}
