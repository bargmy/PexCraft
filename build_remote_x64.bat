...
"%CC_X64%" -m64 -std=c99 -O2 -Wall -Wextra -DPEX_REMOTE_HTTP=1 -DPEX_REMOTE_FPS=30 -mwindows main.c -o pexcraft_remote_x64.exe -static -static-libgcc -ld3d11 -ldxgi -ld3dcompiler -ld3d9 -lopengl32 -lglu32 -lgdi32 -luser32 -lshell32 -lole32 -loleaut32 -lwindowscodecs -lcomdlg32 -lwinmm -lws2_32 -lz -lm
