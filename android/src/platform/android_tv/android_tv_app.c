/* Android TV native SDL2 window, OpenGL ES context, renderer-present, and main loop.
...
int main(int argc, char **argv) {
    ...
    if (!pex_renderer_backend_init(g_hwnd)) {
        SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_ERROR, APP_TITLE, "PEXCRAFT failed to initialize Android TV SDL2/OpenGL ES or load assets.", g_hwnd);
